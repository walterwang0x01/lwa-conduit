...
<p align="center">
  ...
  <img alt="tests" src="https://img.shields.io/badge/tests-302%20passed-brightgreen">
...
>
> **M2 当前**：测试 **302 passed**（ruff / mypy-strict clean），并在真实大 spec
> （staff-identity，17 任务）上端到端跑通；下表为各里程碑的历史快照。
...
- [ ] **M2：实战** — 真实大 spec 端到端**已跑通**（飞书员工 staff-identity：17 任务 / 8 波次，
